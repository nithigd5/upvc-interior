...
export default function Service({title, description, image}) {
    return (
        <div className="relative flex items-center justify-center w-full h-56 group hover:shadow-xl  shadow-lg rounded-xl overflow-hidden cursor-pointer bg-white">
